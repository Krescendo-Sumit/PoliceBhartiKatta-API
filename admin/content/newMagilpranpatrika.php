                ...
                <div class="card">
                    ...
                    if (isset($_POST['btn_save'])) {
                        ...
                        if ($dp == "") {
                            ...
                            $query = "INSERT INTO tbl_magilprashnpatrika_master (id,title,details,`status`,imagepath,accountid,master_accountid,filepath) VALUES "
                                    . "(0,'$title','$details','$status','$dp',1,1,'$fname')";
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <iframe src="fileUplaod/uploadimage.php?tit=magilprashnpatrika" height="140px" width="100%" frameBorder="0" ></iframe>
                                </div>
                                <div class="col-md-4">
                                    <span>PDF File</span><br>
                                    <iframe src="fileUplaod/index.php?tit=magilprashnpatrika" height="140px" width="100%" frameBorder="0"></iframe>
                                </div>
                                <div class="col-md-2"></div>
                            </div>
