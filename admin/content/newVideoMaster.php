    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">New Live Class Batch </li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
                ...
                <div class="card">
                    ...
                    if (isset($_POST['btn_save'])) {
                        ...
                        if ($dp == "") {
                            ...
                            $query = "INSERT INTO tbl_video_master (id,title,details,`status`,imagepath,accountid,master_accountid,rate) VALUES "
                                    . "(0,'$title','$details','$status','$dp',1,1,'$rate')";
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                              ...
                              <div class="col-md-8">
                                    ...
                                    <input type="number" class="form-control input-rounded" name="rate" required>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <iframe src="fileUplaod/uploadimage.php?tit=videobatch" height="140px" width="100%" frameBorder="0" ></iframe>
                                </div>
