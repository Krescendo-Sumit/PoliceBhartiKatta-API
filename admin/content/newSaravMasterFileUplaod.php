    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">New Sarav Master File Upload</li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
                ...
                <div class="card">
                    ...
                    if (isset($_POST['btn_save'])) {
                        ...
                        if ($dp == "") {
                            ...
                            $query = "INSERT INTO tbl_saravprashn_master (id,title,details,`status`,imagepath,accountid,master_accountid) VALUES "
                            ...
                            if (mysqli_query($con, $query)) {
                                ...
                                //  echo "Record Saved. Last Inserted id : &nbsp;".$last_id;
//==================================================
                                ...
                                while (($emapData = fgetcsv($file, 100000, ",")) !== FALSE) {
                                    ...
                                    $sql = "INSERT INTO tbl_sarav_question (id,question,opt1,opt2,opt3,opt4,correct,hint,`status`,cdate,saravid) values"
                                            . "                         (0,'$emapData[0]','$emapData[1]','$emapData[2]','$emapData[3]','$emapData[4]','$emapData[5]','$emapData[6]',1,curdate(),$last_id)";
                                    //     echo $sql . "<br>";
