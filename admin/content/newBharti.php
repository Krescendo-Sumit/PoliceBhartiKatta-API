    ...
    <div class="row page-titles">
        ...
        <div class="col-md-7 align-self-center">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active">New Bharti </li>
            </ol>
        </div>
    </div>
    <!-- End Bread crumb -->
                ...
                <div class="card">
                    ...
                    if (isset($_POST['btn_save'])) {
                        ...
                        if ($dp == "") {
                            ...
                            $query = "INSERT INTO tbl_bharti_master (id,title,details,createddate,master_accountid,accountid,filepath,imagepath,status) VALUES "
                                    . "(0,'$title','$details',curdate(),1,1,'$fname','$dp',$status)";
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <iframe src="fileUplaod/uploadimage.php?tit=bharti" height="140px" width="100%" frameBorder="0" ></iframe>
                                </div>
                                <div class="col-md-4">
                                    <span>PDF File</span><br>
                                    <iframe src="fileUplaod/index.php?tit=bharti" height="140px" width="100%" frameBorder="0"></iframe>
                                </div>
                                <div class="col-md-2"></div>
                            </div>
